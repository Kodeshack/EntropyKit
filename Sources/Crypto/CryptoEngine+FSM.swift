extension CryptoEngine {
    ...
    enum Transition {
        ...
        case encrypt((Event, RoomID, (Result<Event, Error>) -> Void), ((Event, RoomID, (Result<Event, Error>) -> Void)) -> (State, CryptoEngineTask))
        case encryptEvent((Event, RoomID, (Result<Event, Error>) -> Void), ((Event, RoomID, (Result<Event, Error>) -> Void)) -> State)
        ...
        case decrypt((Event, RoomID, (Result<Event, Error>) -> Void), ((Event, RoomID, (Result<Event, Error>) -> Void)) -> State)
        case decryptToDeviceEvent((SyncResponse.ToDeviceEvent, (Result<SyncResponse.ToDeviceEvent, Error>) -> Void), ((SyncResponse.ToDeviceEvent, (Result<SyncResponse.ToDeviceEvent, Error>) -> Void)) -> State)
    ...
    enum CryptoEngineTask {
        ...
        case error(Error)
        case roomID(RoomID)
        case event(event: Event, roomID: RoomID, cb: (Result<Event, Error>) -> Void)
        case roomKeyEvent(event: SyncResponse.ToDeviceEvent)
        case encryptedEvent(event: Event, roomID: RoomID, cb: (Result<Event, Error>) -> Void)
        case encryptedToDeviceEvent(event: SyncResponse.ToDeviceEvent, cb: (Result<SyncResponse.ToDeviceEvent, Error>) -> Void)
